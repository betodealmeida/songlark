...
Welcome to ``songlark`` contributor's guide.
...
If you experience bugs or general issues with ``songlark``, please have a look
...
You can help improve ``songlark`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``songlark`` documentation uses Sphinx_ as its main documentation compiler.
...
.. todo:: If your project is hosted on GitHub, you can also mention the following tip:
   ...
   .. tip::
      ...
      propose changes in ``songlark``'s files. While this mechanism can
...
or Miniconda_::
    ...
    conda create -n songlark python=3 six virtualenv pytest pytest-cov
    conda activate songlark
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/songlark.git
    cd songlark
...
#. Install |pre-commit|_::
   ...
   ``songlark`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/<USERNAME>/songlark
.. _issue tracker: https://github.com/<USERNAME>/songlark/issues
.. <-- end -->
